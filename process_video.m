function mean_bpm = process(y, fps)


W_SECONDS = 7;                  % [s] Sliding window length
...
num_window_samples = round(W_SECONDS * fps);
...
mean_bpm = num2str(mean(bpm_smooth));
